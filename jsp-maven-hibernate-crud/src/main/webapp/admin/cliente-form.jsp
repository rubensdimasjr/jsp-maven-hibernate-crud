...
<title>Cliente Formiguei Doceria</title>
...
<body>
	<header
		...
		<ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
			<li><a href="lista-cliente" class="nav-link px-2 btn btn-danger text-white">Voltar</a></li>
		</ul>
	</header>
	<section class="w-100 mt-5 p-4 d-flex justify-content-center pb-4">
		
		<c:if test="${cliente != null}">
		<form action="update-cliente" method="post" style="width: 26rem;"
			...
			<div class="row mb-4">
				...
				<div class="form-outline mb-4">
					...
					value="<c:out value='${cliente.email}'/>" placeholder="Email" name="email" required>
				</div>

				<!-- Password input -->
				<div class="form-outline mb-4">
					<input type="password" id="senha" class="form-control"
					value="<c:out value='${cliente.senha}'/>" placeholder="Senha" name="senha" required>
				</div>

				<div class="col">
					<div class="form-outline">
						<input type="text" id="form3Example1" placeholder="Nome"
						value="<c:out value='${cliente.nome}'/>" class="form-control" name="nome" required>
					</div>
				</div>
				...
				<div class="col">
					<div class="form-outline">
						...
						value="<c:out value='${cliente.sobreNome}'/>" class="form-control" name="sobreNome" required>
					</div>
				</div>
